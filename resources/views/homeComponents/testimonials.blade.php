        ...
        <div class="flex animate-loop-scroll group-hover:paused">
            ...
            <div class="flex flex-col justify-between items-center px-32 mx-2 rounded-lg min-w-[35rem] max-w-[35rem] bg-white shadow-2xl">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    @if (Str::startsWith($testimonial->testimonial_image, 'http'))
                        <img src="{{ $testimonial->testimonial_image }}" class="w-20 h-20 rounded-full" alt="Testimonial Image">
                    @else
                        <img src="assets/{{ $testimonial->testimonial_image }}" class="w-20 h-20 rounded-full" alt="Testimonial Image">
                    @endif
