        ...
        <div class="flex flex-col lg:flex-row justify-around mx-10">
            <div>
                ...
                <ul>
                    ...
                    <li class="flex">
                        <i class="fa fa-solid fa-envelope pt-2 pr-5"></i>training@deerwalkcompware.com
                    </li>
                </ul>
            </div>
            <div class="px-10">
            ...
            <div>
                <div>
                    <ul class="font-medium flex flex-row lg:flex-col items-center justify-between lg:justify-start lg:items-start">
                        <li class="pb-5 pr-3"><a href="{{ route('blog.index') }}">Blog</a></li>
                        <li class="pb-5 pr-3"><a href="{{ route('terms') }}">Policy</a></li>
                        <li class="pb-5 pr-3"><a href="{{ route('contact.create') }}">Contact</a></li>
                        <li class="pb-5 pr-3"><a href="{{ route('team.index') }}">Team</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class=" border-t border-gray-500 pt-3 w-full mx-10">
            <p class="text-xl text-center">© 2024 Deerwalk Compware. All Rights Reserved.</p>
        </div>
    </div>