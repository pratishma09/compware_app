...
@section('admin')
<div class="mt-5">
    <h2 class="text-2xl">Edit Event Gallery</h2>
    ...
    <form action="{{ route('admin.eventgalleries.update', ['id' => $eventgallery->id]) }}" method="post" enctype="multipart/form-data" class="mx-auto bg-white py-6 rounded-lg w-full">
        ...
        <button type="submit" class="mx-auto py-2 px-4 border border-transparent rounded-md shadow-sm text-white bg-blue hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update Event Gallery</button>
    </form>
