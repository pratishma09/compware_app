...
@section('content')
    ...
    <form method="post" action="{{ route('studentcertificate.store') }}" enctype="multipart/form-data">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="trainer_title" class="form-control" placeholder="Trainer Title">
        </div>
        <div>
